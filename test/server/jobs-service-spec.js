...
var db={
    ...
    findJobs:function(){return new Promise(function(resolve,reject){
            resolve(["hi"]);
        })
    }
};
...
describe("get json jobs", function(){
    it("get should give me a list of json jobs", function(done){
...
describe("save jobs",function(){
    ...
    it("should pass the job to database server",function(done){
